...
Feature: The my overview block allows users to hide their courses
  ...
  Scenario: Test a course is never hidden with "All (including removed from view)" courses
    ...
    Then I should see "Course 2" in the "Course overview" "block"
    And I click on ".local-co-iconbtn" "css_element" in the "//article[contains(concat(' ', normalize-space(@class), ' '), ' local-co-card ') and contains(.,'Course 2')]" "xpath_element"
    And I should not see "Remove from view" in the "//article[contains(concat(' ', normalize-space(@class), ' '), ' local-co-card ') and contains(.,'Course 2')]" "xpath_element"
    And I should see "Restore to view" in the "//article[contains(concat(' ', normalize-space(@class), ' '), ' local-co-card ') and contains(.,'Course 2')]" "xpath_element"
    And I click on "Restore to view" "button" in the "//article[contains(concat(' ', normalize-space(@class), ' '), ' local-co-card ') and contains(.,'Course 2')]" "xpath_element"
    And I should see "Course 2" in the "Course overview" "block"
    And I click on ".local-co-iconbtn" "css_element" in the "//article[contains(concat(' ', normalize-space(@class), ' '), ' local-co-card ') and contains(.,'Course 2')]" "xpath_element"
    And I should see "Remove from view" in the "//article[contains(concat(' ', normalize-space(@class), ' '), ' local-co-card ') and contains(.,'Course 2')]" "xpath_element"
    And I should not see "Restore to view" in the "//article[contains(concat(' ', normalize-space(@class), ' '), ' local-co-card ') and contains(.,'Course 2')]" "xpath_element"
